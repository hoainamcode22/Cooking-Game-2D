// Disabled: duplicate of HappyHarvest/Scripts/DayEventHandler.cs — use Day_Night.DayNightDayEventHandler instead
#if false
using System;
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (dayHandler != null)
            {
                ...
                slider.RegisterValueChangedCallback(evt =>
                {
                    ...
                    slider.label = $"Day range {GameManager.GetTimeAsString(minProperty.floatValue)} - {GameManager.GetTimeAsString(maxProperty.floatValue)}";
                });
            ...
            {
                container.Add(new Label("There is no DayCycleHandler in the scene and it is needed"));
            }
