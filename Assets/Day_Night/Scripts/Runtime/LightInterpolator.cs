// Disabled: duplicate of HappyHarvest/Scripts/Effects/LightInterpolator.cs — use Day_Night.DayNightLightInterpolator instead
#if false
using System;
...
namespace HappyHarvest
{
    ...
    public class LightInterpolatorEditor : Editor
    {
        ...
        void SceneUpdate()
        {
            if (m_PreviewSlider == null || m_Interpolator == null || m_DayCycleHandler == null)
                return;
        ...
        void CustomUI(VisualElement root)
        {
            ...
            list.makeItem += () =>
            {
                ...
                foldout.Add(new PropertyField() { name = "ReferenceLightEntry" });
                foldout.Add(new PropertyField() { name = "TimeEntry" });
                return foldout;
            };
            ...
            list.bindItem += (element, i) =>
            {
                ...
                element.Q<PropertyField>("ReferenceLightEntry").BindProperty(refLight);
                element.Q<PropertyField>("TimeEntry").BindProperty(entry.FindPropertyRelative(nameof(LightInterpolator.LightFrame.NormalizedTime)));
            };
