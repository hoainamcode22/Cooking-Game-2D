...
public static class MasterArtImportTool
{
    ...
    private static readonly Mon[] DANH_SACH =
    {
        ...
        // ── GÓI B — icon gia vị ──────────────────────────────────────────────
        // [VÒNG 16] Bản gốc thừa 45–66% khung trong suốt ⇒ icon hiện ra nhỏ tí trong ô.
        // Đã cắt sát rồi đặt lại vào KHUNG VUÔNG CHUNG 232×232 (giữ nguyên tỉ lệ to/nhỏ
        // giữa 3 icon với nhau). Bản gốc vẫn còn ở B_Icon_GiaVi/ nếu cần đối chiếu.
        M("B", "ing_rau.png",         "B_Icon_CatDeu", "Assets/Art/UI/Ingredients"),
        M("B", "ing_nuoc_mam.png",    "B_Icon_CatDeu", "Assets/Art/UI/Ingredients"),
        M("B", "ing_nuoc_tuong.png",  "B_Icon_CatDeu", "Assets/Art/UI/Ingredients"),
