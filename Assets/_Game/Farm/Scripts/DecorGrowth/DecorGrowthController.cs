...
public class DecorGrowthController : MonoBehaviour
{
    ...
    {
        if (TutorialManager.Instance != null && TutorialManager.Instance.DangChayTutorial) return false;
    ...
    private void OnMouseUpAsButton()
    {
        ...
        // IsPointerOverGameObject() tra TRUE ngay khi con tro nam tren collider CUA CHINH
        // vat nay => decor/chuong tu chan click cua minh, khong bao gio mo duoc process.
        // OnMouseUpAsButton chi no khi da o tren collider vat nay roi, nen chi can cong
        // danh theo scene/popup (khong kiem UI duoi con tro).
