...
public class FarmAmbientFX : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 chimLechBong = new Vector2(160f, -150f);
    ...
    private void Start()
    {
        if (_phienBan < PHIEN_BAN)
        {
            // [2026-09-24] Object dung tu ban truoc giu thong so cu trong scene -> nang len ban moi
            if (chimKichThuoc < 200f) chimKichThuoc = 200f;
            if (chimDoCao < 0.75f) chimDoCao = 0.75f;
