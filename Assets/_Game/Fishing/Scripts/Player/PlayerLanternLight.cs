...
namespace FarmGame.Fishing
{
    ...
    public class PlayerLanternLight : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            // VONG 14b: ban ngay mo den (0.45) thay vi sang full (1f) — ban ngay von da
            // du sang, de 1f la cong them vao buffer Multiply lam chay sang.
            _light.intensity = baseIntensity * Mathf.Lerp(0.45f, NightMultiplier, _nightBlend);
        }
