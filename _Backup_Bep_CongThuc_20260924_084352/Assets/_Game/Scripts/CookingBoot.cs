...
public class CookingBoot : MonoBehaviour
{
    ...
    // [2026-09-24] Qua khoi dau: moi nguyen lieu + gia vi co san 5 trong bep (1 lan duy nhat).
    // Khoa bat dau bang "KITCHEN_TRANSFER" -> SaveVersionGuard / choi lai tu dau xoa cung save bep.
