...
public static class TouristOrderBubbleTool
{
    ...
    private static GameObject DungCay(Transform canvas)
    {
        ...
        Chu(tt, "Khách đặt món", 26f, new Color(0.4f, 0.2f, 0.05f), TextAlignmentOptions.Center, true);
        ...
        var tTen = Chu(ten, "Tên món", 32f, NauDam, TextAlignmentOptions.Left, true); tTen.fontSizeMin = 20f;
        var kho = Tao("Txt_Stock", frame, trenTrai, trenTrai, trenTrai, new Vector2(198f, -104f), new Vector2(372f, 30f));
        Chu(kho, "Trong kho: 0", 22f, NauNhat, TextAlignmentOptions.Left, false);
        ...
        Chu(need, "Nguyên liệu cần nấu:", 22f, NauDam, TextAlignmentOptions.Left, true);
        ...
        Chu(ta, "Giao món", 34f, Color.white, TextAlignmentOptions.Center, true);
        ...
        Chu(ft, "Ngon quá! Cảm ơn!", 36f, new Color(0.85f, 0.32f, 0.2f), TextAlignmentOptions.Center, true);
