...
/// <summary>
/// [JUICE PACK T3 — 2026-08-31] Nhân vật MASCOT ăn mừng trên popup Level-Up
...
///     LevelUpMascotUI.AttachTo(badgeRect, levelReached);
///
...
/// </summary>
public class LevelUpMascotUI : MonoBehaviour
{
    ...
    public static LevelUpMascotUI AttachTo(RectTransform parent, int levelReached)
    {
        ...
        var ui = go.AddComponent<LevelUpMascotUI>();
