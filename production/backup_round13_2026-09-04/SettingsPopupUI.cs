...
public class SettingsPopupUI : MonoBehaviour
{
    ...
    private void UpdateBgmToggleVisual(bool enabled)
    {
        ...
        {
            txtToggleBgm.text = enabled ? "BẬT" : "TẮT";
    ...
    private void UpdateSfxToggleVisual(bool enabled)
    {
        ...
        {
            txtToggleSfx.text = enabled ? "BẬT" : "TẮT";
    ...
    public static SettingsPopupUI CreateHierarchy(Transform canvas)
    {
        ...
        BuildAudioRow(parchment, "Row_BGM", "Âm thanh game", 120f, sprCardDark, sprTrackBar, sprProgressFill, sprHandleDisc, sprBtnGreen3D,
            out Slider bgmSlider, out Button bgmToggleBtn, out Image bgmToggleBg, out TMP_Text bgmToggleTxt);
        ...
        BuildAudioRow(parchment, "Row_SFX", "Âm thanh VFX", 35f, sprCardDark, sprTrackBar, sprProgressFill, sprHandleDisc, sprBtnGreen3D,
            out Slider sfxSlider, out Button sfxToggleBtn, out Image sfxToggleBg, out TMP_Text sfxToggleTxt);
        ...
        BuildLanguageRow(parchment, -55f, sprCardDark, sprBtnYellow3D, sprBtnDisabled3D, sprCheckBadge,
            out Button btnVi, out Button btnEn, out Image bgVi, out Image bgEn, out GameObject chkVi, out GameObject chkEn);
        ui.btnLangVi = btnVi;
        ui.btnLangEn = btnEn;
        ui.imgLangViBg = bgVi;
        ui.imgLangEnBg = bgEn;
        ...
        // ── Nút Đóng / Lưu 3D phía dưới (Y: -155) ───────────────────────────
        RectTransform saveBtnRt = CreateRect(parchment, "Btn_BottomClose", new Vector2(240f, 62f), new Vector2(0f, -152f));
        AddImage(saveBtnRt.gameObject, Color.white, sprBtnGreen3D, true);

        TMP_Text saveTxt = CreateText(saveBtnRt, "Txt_Save", "ĐÓNG", 24, Color.white, TextAlignmentOptions.Center, new Vector2(0f, 3f), new Vector2(220f, 50f), FontStyles.Bold);
    ...
    private static void BuildAudioRow(RectTransform parent, string name, string label, float posY,
        ...
        out Slider slider, out Button toggleBtn, out Image toggleBg, out TMP_Text toggleTxt)
    {
