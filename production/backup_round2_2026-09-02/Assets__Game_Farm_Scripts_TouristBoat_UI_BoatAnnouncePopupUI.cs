...
public class BoatAnnouncePopupUI : MonoBehaviour
{
    ...
    private IEnumerator HienPopupRoutine(int dockIndex, DateTime arrivalUtc, int phut)
    {
        ...
        if (bodyText != null)
        {
            bodyText.text = $"Sẽ cập bến sau {phut} phút. Hãy chuẩn bị đón khách nhé!";
            bodyText.color = Color.white; // Trắng sáng rõ ràng
        ...
        if (cardRect != null)
        {
            ...
            cardRect.sizeDelta = new Vector2(420f, 105f);
            cardRect.anchoredPosition = new Vector2(350f, -135f); // Bắt đầu ngoài mép phải
        }
    ...
    private IEnumerator MoAnimRoutine()
    {
        ...
        Vector2 startPos = new Vector2(350f, -135f);
    ...
    private IEnumerator DongAnimRoutine()
    {
        ...
        Vector2 endPos = new Vector2(350f, -135f);
