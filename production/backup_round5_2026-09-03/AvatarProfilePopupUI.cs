...
public class AvatarProfilePopupUI : MonoBehaviour
{
    ...
    private static void CreateFreshHierarchy(AvatarProfilePopupUI ui, Transform root)
    {
        ...
        // 3. Nút đóng [X] đỏ 3D (68 x 68) bo tròn
        RectTransform closeRt = CreateRect(board, "Btn_Close", new Vector2(68f, 68f), new Vector2(470f, 290f));
        Image closeImg = AddImage(closeRt.gameObject, new Color32(140, 20, 25, 255), SkinKit.HinhTron(), true);
        RectTransform closeInner = CreateRect(closeRt, "Inner", new Vector2(60f, 60f), Vector2.zero);
        ...
        TMP_Text xTxt = CreateText(closeRt, "Txt_X", "X", 28, Color.white, TextAlignmentOptions.Center, new Vector2(0f, 1f), new Vector2(54f, 54f), FontStyles.Bold);
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            // 1. Viền sáng xanh lá quanh ô avatar (Outline)
            ...
            // 2. Huy hiệu tròn dấu tích chữ V ở góc dưới bên phải (Badge Checkmark)
        ...
        CreateText(nameBox, "Txt_Pencil", "SỬA", 14, new Color32(163, 128, 63, 255), TextAlignmentOptions.Center, new Vector2(240f, 0f), new Vector2(40f, 40f), FontStyles.Bold);
        ...
        // Ruột thanh EXP: Xanh dương biển (#1CA4FF) đồng bộ hoàn hảo với HUD ngoài
        Image fillImg = AddImage(fillRt.gameObject, new Color32(28, 164, 255, 255), BoGoc(13f), false);
        ...
        AddImage(gloss.gameObject, new Color32(150, 225, 255, 120), BoGoc(13f), false);
        ...
        Sprite warehouseSpr = null;
        Sprite cookingSpr = null;
        Sprite goldSpr = null;
        Sprite achSpr = null;

#if UNITY_EDITOR
        warehouseSpr = UnityEditor.AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Assetsgame/bocaycoitrangtri/ICON_HUB/icon_warehouse_v2_1786984374562-removebg-preview.png");
        cookingSpr = UnityEditor.AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Icons/icon_cooking_building.png");
        goldSpr = UnityEditor.AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Art/UI/Currency/icon_gold.png")
               ?? UnityEditor.AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Export_Kitchen_UI_Package/Sprites/icon_gold.png");
        achSpr = UnityEditor.AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Assetsgame/bocaycoitrangtri/ICON_HUB/icon_market_board_v2_1786984419449-removebg-preview.png");
#endif
        if (warehouseSpr == null) warehouseSpr = Resources.Load<Sprite>("Icons/icon_warehouse");
        if (cookingSpr == null)   cookingSpr   = Resources.Load<Sprite>("Icons/icon_cooking_building");
    ...
    private static TMP_Text CreateStatCard(Transform parent, string name, string label, string val, Sprite icon, Vector2 pos)
    {
        ...
        TMP_Text txtVal = CreateText(fill, "Txt_Value", val, 18, new Color32(75, 40, 15, 255), TextAlignmentOptions.Left, new Vector2(28f, -12f), new Vector2(170f, 26f), FontStyles.Bold);
