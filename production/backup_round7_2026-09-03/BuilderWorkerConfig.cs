...
public class BuilderWorkerConfig : ScriptableObject
{
    ...
    [Tooltip("Khoảng ĐỆM THÊM ngoài điểm đứng (world unit). Sếp báo thợ đứng xa công trình " +
             "nên hạ 40 -> 6 (2026-09-03).")]
    public float placementRadiusPadding = 6f;

    [Tooltip("Thợ đứng cách TÂM công trình bao nhiêu phần bán kính (0.4 = sát vào lòng, " +
             "1.0 = ngoài rìa như cũ). 0.62 = sát công trình mà không bị che.")]
    public float placementInsetRatio = 0.62f;
