...
namespace KitchenUIv2
{
    ...
    public class KitchenSceneV2UI : MonoBehaviour
    {
        ...
        private void BuildOrderBanner()
        {
            ...
            Anchor(ribbonB, 0.5f, 1f, new Vector2(0f, 10f), new Vector2(240f, 34f), new Vector2(0.5f, 0.5f));
        ...
        private void BuildRecipeBoard()
        {
            ...
            Anchor(ribbonR, 0.5f, 1f, new Vector2(0f, 10f), new Vector2(230f, 34f), new Vector2(0.5f, 0.5f));
        ...
        private void BuildStage()
        {
            ...
            SkinFlat(wh, skin.warehouseHatch);
