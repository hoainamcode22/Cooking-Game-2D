...
public static class DecorProgressPopupBridge
{
    ...
    private static void Build()
    {
        ...
        Sprite bgSprite = LoadFirstSprite(PanelSpriteCandidates);
        if (bgSprite != null)
        {
            bg.sprite = bgSprite;
        ...
        Sprite btnSprite = LoadFirstSprite(ButtonSpriteCandidates);
        if (btnSprite != null)
        {
        ...
        Sprite gemSprite = LoadFirstSprite(GemSpriteCandidates);
        if (gemSprite != null) gemImg.sprite = gemSprite;
